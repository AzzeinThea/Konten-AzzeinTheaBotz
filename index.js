/*
  ...
  > FOR NEW UPDATES PLEASE VISIT MY YOUTUBE CHANNEL --> AZZEINTHEA <--
...
cmd_stc_ping = '7292'
//untuk donasi
var nomor_ovo = `082130514272\nA.N ASEP ZAENAL` //gk usah di ubah ya klo gk punya ntr eror
var nomor_dana = `08979515888\nA.N ASEP ZAENAL` //gk usah di ubah ya klo gk punya ntr eror
var nomor_gopay = `082130514272\nA.N ASEP ZAENAL` //gk usah di ubah ya klo gk punya ntr eror
var qr_code_ovo = 'https://j.top4top.io/p_2069keksp0.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_dana = 'https://d.top4top.io/p_2069zamcs0.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_gopay = 'https://e.top4top.io/p_20699wlxg0.jpg' //gk usah di ubah ya klo gk punya ntr eror
...
const UserAzzeinthea = JSON.parse(fs.readFileSync('./nayla/UserAlphabot.json')) 
...
/*=====================================================[ CONNECTING  ]==============================================================*/                  	    
	...
	nayla.on('qr', () => {
     		console.log(color('[','white'), color('!','red'), color(']','white'), color('SUBSCRIBE YOUTUBE AZZEINTHEA'))
	        })
...
remoteJid: "0@s.whatsapp.net"},message: {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "Alphabot", "caption": `Made With ❤️`, 'jpegThumbnail': fs.readFileSync(`image/${setting.thumb}`)}}}
  ...
  try {
					...
					ppimg = 'https://i.ibb.co/0n0vDG8/20210902-131114.png'
				}
			let buff = await getBuffer(ppimg)
...
/*=====================================================[ API DEVELOP ]==============================================================*/                  	                 
		...
		if (multi){
			...
			const isPrem = prem.includes(sender) || isOwner : true				
    ...
    return new Promise(resolve => setTimeout(resolve, ms));
	        ...
	        UserAzzeinthea.push(obj)
          	fs.writeFileSync('./nayla/UserAlphabot.json', JSON.stringify(UserAzzeinthea))
            }	
            const checkUserAlphabot = (sender) => {
	        let status = false
	        Object.keys(UserAzzeinthea).forEach((i) => {
		    if (UserAzzeinthea[i].id === sender) {
			status = true
		    }
	        })
	        return status
		...
		message: {
			"productMessage": {
				"product": {
					"productImage":{
						"mimetype": "image/jpeg",
						"jpegThumbnail": fs.readFileSync(`image/${hanzhen.jpeg}{thumbnail}`) //Gambarnye
					},
					"title": 'Pijat Reflexi', 
					"description": "Pijat Titik Syaraf bagian telapak kaki,telapak tangan, pundak dan kepala dengan durasi wakty 1,5jam", 
					"currencyCode": "IDR",
					"priceAmount1000": "100000/1,5jam",
					"retailerId": 'Whatsapp Bot',
					"productImageCount": 1
				},
				    "businessOwnerJid": `6282130514272@s.whatsapp.net`
		}
...
//+++++++++++TIME+++++++++++//
 ...
 //+++++++++++UCAPAN+++++++++++//
            ...
            */const vnayla = 'BEGIN:VCARD\n' 
            ...
            + `FN: AZZEINTHEA\n` 
            + `ORG: AUTHOR;\n`
            + `TEL;type=CELL;type=VOICE;waid=628979515888:+628979515888\n`
            + 'END:VCARD' 
...
for (let azzeinThea of setiker){
	if (budy === azzeinThea){
		result = fs.readFileSync(`./src/sticker/${azzeinThea}.webp`)
		nayla.sendMessage(from, result,sticker, {quoted : ftroli})
		}
}
for (let azzeinThea of audionye){
	if (budy === azzeinThea){
		result = fs.readFileSync(`./src/audio/${azzeinThea}.mp3`)
		nayla.sendMessage(from, result, audio, {mimetype :  'audio/mp4' , duration : 359996400, ptt : true, quoted : ftroli})
		}
}
for (let azzeinThea of imagenye){
	if (budy === azzeinThea){
		result = fs.readFileSync(`./src/foto/${azzeinThea}.jpg`)
		nayla.sendMessage(from, result,image, {quoted : ftroli})
		}
}
for (let azzeinTheaw of videonye){
	if (budy === azzeinTheaw){
		result = fs.readFileSync(`./src/video/${azzeinTheaw}.mp4`)
...
*/                                        
			        ...
			        case 'join':  
                    if (!isUserAlphabot) return replyByAzzeinThea(mess.only.userB) 
                    ...
                    nayla.sendMessage(`${setting.ownerNumber}@s.whatsapp.net`, optionsp, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "caption": `SUBSCRIBE YT AZZEINTHEA`} } } })                    
                    reply('BOTS WILL BE COMING SOON. SUBSCRIBE MY YOUTUBE AZZEIN THEA')                     
					break  
		case 'claim':
...
│\`\`\`atau ${prefix}allmenu\`\`\`
│
│\`\`\`\Users total : ${UserAzzeinThea.length} Users\`\`\`
╰─────────────────────`
...
nayla.sendMessage(from,  btn1, MessageType.buttonsMessage, {quoted: fkontak})
        ...
        case 'allmenu':
        if (!isUserAlphabot) return replyByAzzeinThea(mess.only.userB) 
        reply(helpmenu(wit,wita,wib,tampilTanggal, UserAzzeinThea, tampilHari , limitawal, role, premi, sender, botname,pushname, prefix, wa_version, mcc, mnc, os_version, device_manufacturer, device_model ))
               break
	case 'menu2':
if (!isUserAlphabot) return replyByAzzeinThea(mess.only.userB) 
...
case 'setprefix':
       ...
       case 'author':  
	    ...
	    case 's':  	
					...
					.on('end', function () {
					console.log('SELESAI JANGAN LUPA SUBSCRIBE YT AZZEINTHEA')
...
/*====================================================[ CASE LOLTEAM ]==============================================================*/                    	 
		...
		case 'hidetag10':  
          ...
          case 'greenneon':
                ...
                case 'horrorblood':
                case 'thunder':
                    if (args.length < 1) return reply(`Example: ${prefix + command} AZZEINTHEA`)
                    ini_txt = args.join(" ")
...
/*====================================================[ CASE BY NAYLA ]==============================================================*/                    	 
		...
		case 'tebakkimia': 
	      ...
	      case 'tebaklirik': 
					...
					var ini_gopay =`Halo @${sender.split("@")[0]} itu owner ku, jangan lupa donasi kak😇`
var buttonns = [
...
nayla.sendMessage(from,  buttonMessage, MessageType.buttonsMessage,{
        caption: 'Botwea ©2k21',
        "contextInfo": {
            text: 'hi',
            "forwardingScore": 1000000000,
...
${petik}々 Total User : ${UserAzzeinathea.length}${petik}`
let contentt = fs.readFileSync(`image/${thumbnail}`)
...
if (subscribeAzzeinThea == `verify_kak`) {
	if (isUserAlphabot) return reply(`Hai ${pushname} Anda sudah terdaftar di database`)
					...
					imglu = `${img}` 
					veri = sender
					UserAzzeinathea.push(sender)
					fs.writeFileSync('./nayla/UserAlphabot.json', JSON.stringify(UserAzzeinathea))
...
│\`\`\`atau ${prefix}allmenu\`\`\`
│
│\`\`\`\Users total : ${UserAzzeinathea.length} Users\`\`\`
╰─────────────────────`
					let buff = await getBuffer(ppimg)
...
if(subscribeAzzeinThea == 'qr_dana'){
...
if(subscribeAzzeinThea == 'qr_gopay'){
...
if(subscribeAzzeinThea == 'qr_ovo1'){
	gambar_ovo = `${qr_code_ovo}`
	let gambar_ovo_nya = await getBuffer(gambar_ovo)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
...
if(subscribeAzzeinThea == 'qr_dana1'){
	gambar_dana = `${qr_code_dana}`
	let gambar_dana_nya = await getBuffer(gambar_dana)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_gopay1'){
	gambar_gopay = `${qr_code_gopay}`
	let gambar_gopay_nya = await getBuffer(gambar_gopay)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_ovo2'){
	gambar_ovo = `${qr_code_ovo}`
	let gambar_ovo_nya = await getBuffer(gambar_ovo)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_dana2'){
	gambar_dana = `${qr_code_dana}`
	let gambar_dana_nya = await getBuffer(gambar_dana)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_gopay2'){
	gambar_gopay = `${qr_code_gopay}`
	let gambar_gopay_nya = await getBuffer(gambar_gopay)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_ovo3'){
	gambar_ovo = `${qr_code_ovo}`
	let gambar_ovo_nya = await getBuffer(gambar_ovo)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_dana3'){
	gambar_dana = `${qr_code_dana}`
	let gambar_dana_nya = await getBuffer(gambar_dana)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_gopay3'){
	gambar_gopay = `${qr_code_gopay}`
	let gambar_gopay_nya = await getBuffer(gambar_gopay)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_ovo4'){
	gambar_ovo = `${qr_code_ovo}`
	let gambar_ovo_nya = await getBuffer(gambar_ovo)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_dana4'){
	gambar_dana = `${qr_code_dana}`
	let gambar_dana_nya = await getBuffer(gambar_dana)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_gopay4'){
	gambar_gopay = `${qr_code_gopay}`
	let gambar_gopay_nya = await getBuffer(gambar_gopay)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_ovo5'){
	gambar_ovo = `${qr_code_ovo}`
	let gambar_ovo_nya = await getBuffer(gambar_ovo)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_dana5'){
	gambar_dana = `${qr_code_dana}`
	let gambar_dana_nya = await getBuffer(gambar_dana)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
...
if(subscribeAzzeinThea == 'qr_gopay5'){
	gambar_gopay = `${qr_code_gopay}`
	let gambar_gopay_nya = await getBuffer(gambar_gopay)
	ini_bayar = `${ucapannya}\n\n•> Nama : _${pushname}_
•> Nomor : _@${sender.split("@")[0]}_
